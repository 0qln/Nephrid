...
#[test]
fn split_north() {
    assert_eq!(Bitboard::split_north(A1), Bitboard { v: 0xfffffffffffffffeu64 });
    assert_eq!(Bitboard::split_north(B1), Bitboard { v: 0xfffffffffffffffcu64 });
    assert_eq!(Bitboard::split_north(A5), Bitboard { v: 0xfffffffe00000000u64 });
    assert_eq!(Bitboard::split_north(G8), Bitboard { v: 0x8000000000000000u64 });
...
fn split_south() {
    ...
    assert_eq!(Bitboard::split_south(G8), Bitboard { v: 0x3fffffffffffffffu64 });
    assert_eq!(Bitboard::split_south(H8), Bitboard { v: 0x7fffffffffffffffu64 });
}
