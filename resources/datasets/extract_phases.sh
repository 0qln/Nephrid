...
python resources/datasets/extract_phase.py --phase 6 --themes "endgame&short&crushing"
python resources/datasets/extract_phase.py --phase 7 --themes "endgame&short&advantage"
